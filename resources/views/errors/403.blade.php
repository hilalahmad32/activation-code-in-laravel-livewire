...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="bootstrap-css"
        href="https://app.lanaieka.com/assets/plugins/bootstrap/css/bootstrap.min.css?v=2.9.3">
    <link rel="stylesheet" type="text/css" id="roboto-css"
        href="https://app.lanaieka.com/assets/plugins/roboto/roboto.css?v=2.9.3">
    <link rel="stylesheet" type="text/css" id="bootstrap-overrides"
        href="https://app.lanaieka.com/assets/css/bs-overides.min.css?v=2.9.3">
    @livewireStyles
    <style>
        body {
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 authentication-form-wrapper">
                ...
                <div class="mtop40 authentication-form">
                    ...
                    <p>Your Status is not Approved</p>
                    <div class="form-group">
                        <a href="{{ route('users.logout') }}" style="text-decoration: none"><button type="submit"
