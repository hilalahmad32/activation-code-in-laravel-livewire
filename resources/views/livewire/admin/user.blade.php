                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        ...
                                        Name</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        colspan="1" aria-label="Icon activate to sort column ascending">Email</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        colspan="1" aria-label="Parent activate to sort column ascending">Status
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                    ...
                                    <th class="sorting not-export" tabindex="0" aria-controls="DataTables_Table_0"
                                        rowspan="1" colspan="1"
                                        aria-label="Options activate to sort column ascending">Approve</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($users as $user)
                                    <tr class="odd">
                                        ...
                                        <td>{{ $user->name }}</td>
                                        <td>{{ $user->email }}</td>
                                        <td>{{ $user->status == 1 ? 'Approved' : 'Not Apporved' }}</td>
                                        <td><button wire:click='delete({{ $user->id }})'
                                                class="btn btn-danger">Delete</button></td>

                                        @if ($user->status == 1)
                                            <td><button wire:click='disApproved({{ $user->id }})'
                                                    class="btn btn-success">DisApproved</button></td>
                                        @else
                                            <td><button wire:click='approved({{ $user->id }})'
                                                    class="btn btn-success">Approved</button></td>
                                        @endif
